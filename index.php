...
<!-- nav start -->
  ...
  <nav>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <a href="#"><i class="fa-solid fa-cart-shopping fa-lg" style="color: #ffffff;"></i> &nbsp Store</a>
        <a href="login.php"><i class="fa-solid fa-circle-user fa-lg" style="color: #ffffff;"></i>&nbsp Login</a>
    </div>
  ...
  <div class="ml-auto">
        ...
        <div class="dropdown-content mega-menu">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <ul>
                        <li><a href="#" onclick="alert('please login first')">AIP ++ &nbsp <img src="icons/aip++-01.png" alt="" height="20px"width="20px"></a></li>
                        <li><a href="#" onclick="alert('please login first')">Pydora &nbsp<img src="icons/pydora-01.png" alt="" height="20px"width="20px"></a></li>
                        <li><a href="#" onclick="alert('please login first')">Rustify &nbsp<img src="icons/rustify-01.png" alt="" height="20px"width="20px"></a></li>
                        <li><a href="#" onclick="alert('please login first')">Inteli Java &nbsp<img src="icons/java-01.png" alt="" height="20px"width="20px"></a></li>
                      </ul>
                </div>
                <div class="col-md-4">
                  <h4></h4><br>
                    <ul>
                      <li><a href="#" onclick="alert('please login first')">Feet &nbsp<img src="icons/feet-01.png" alt="" height="20px"width="20px"></a></li>
                      <li><a href="#" onclick="alert('please login first')">Go land &nbsp<img src="icons/goland-01.png" alt="" height="20px"width="20px"></a></li>
                      <li><a href="#" onclick="alert('please login first')">Php slash &nbsp<img src="icons/phps-01.png" alt="" height="20px"width="20px"></a></li>
                    </ul>
                </div>
        ...
        <div class="dropdown-content mega-menu">
            ...
            <div class="row">
              <div class="col-md-4">
                  <h4>Company 1</h4>
                  <ul>
                      <li><a href="#" onclick="alert('please login first')">About Us</a></li>
                      <li><a href="#" onclick="alert('please login first')"></a></li>
                  </ul>
              </div>
              <div class="col-md-4">
                  <h4>Company 2</h4>
                  <ul>
                      <li><a href="#" onclick="alert('please login first')">Blogs</a></li>
                      <li><a href="#" onclick="alert('please login first')">Contact Us</a></li>
                  </ul>
              </div>
              <!-- Add more columns as needed -->
          </div>
        ...
        <div class="dropdown-content mega-menu">
            ...
            <div class="row">
              <div class="col-md-4">
                  <h4>Support 1</h4>
                  <ul>
                      <li><a href="#" onclick="alert('please login first')">C++ tool</a></li>
                      <li><a href="#" onclick="alert('please login first')">Dev Ops</a></li>
                  </ul>
              </div>
              <div class="col-md-4">
                  <h4>Support 2</h4>
                  <ul>
                      <li><a href="#" onclick="alert('please login first')">Game Development</a></li>
                      <li><a href="#" onclick="alert('please login first')">Software Development</a></li>
                  </ul>
              </div>
              <!-- Add more columns as needed -->
          </div>
    ...
    <a href="login.php"><i class="fa-solid fa-circle-user fa-lg" style="color: #ffffff;"></i></a>
    <a href="#" onclick="alert('please login first')"><i class="fa-solid fa-cart-shopping fa-lg" style="color: #ffffff;"></i></a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block col-lg-5">
                        ...
                        <a class="btn glow-on-hover" href="#" onclick="alert('please login first')" role="button">TRY US NOW &nbsp; &nbsp;<i class="fa-solid fa-arrow-right"></i></a>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="under">
                      <div class="over">
                         ...
                         <a href="#" onclick="alert('please login first')" class="about_btn"> Order Now</a>
                        </div>
                      </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-3">
                ...
                <a href="#" onclick="alert('please login first')">Aip++ </a><br><br>
                <a href="#" onclick="alert('please login first')">Py dora</a><br><br>
                <a href="#" onclick="alert('please login first')">inteli java</a><br><br>
                <a href="#" onclick="alert('please login first')">Feet</a><br><br>
                <a href="#" onclick="alert('please login first')">Go land</a><br><br>
                <a href="#" onclick="alert('please login first')">Php slash</a><br><br>
                <a href="#" onclick="alert('please login first')">Rustify</a><br><br>
              </div>
            ...
            <div class="col-lg-3">
              <div class="f_content">
              <h3>SUPPORT</h3><br>
              <a href="#" onclick="alert('please login first')">C++ tools</a><br><br>
              <a href="#" onclick="alert('please login first')">Dev ops</a><br><br>
              <a href="#" onclick="alert('please login first')">Game development</a><br><br>
              <a href="#" onclick="alert('please login first')">Software development</a><br><br>
            </div>
          </div>
          <div class="col-lg-3">
            <div class="f_content">
            <h3>COMPANY</h3><br>
            <a href="#" onclick="alert('please login first')">About Us</a><br><br>
            <a href="#">News</a><br><br>
            <a href="#">Blogs</a><br><br>
            <a href="#" onclick="alert('please login first')">Contact Us</a><br><br>
          </div>
         </div>
         <div class="col-lg-3">
